...
class HoursNormsScreen extends StatelessWidget {
  ...
  final String periodTitle; // "01 Mar 25 - 15 Mar 25"
  final double workedHours; // 48
  final double plannedHours; // 150
  final double normHours; // 184

  final String wagonTypeTitle; // "Плацкартный (54)"
  final DateTime validFrom; // 14.12.2025
  final DateTime validTo;   // 20.12.2025

  final double workTrip;  // 41.17
  final double guard;     // 8.22
  final double workTotal; // 55.08
  final double restTime;  // 23.38
  final double grandTotal;// 78.47
