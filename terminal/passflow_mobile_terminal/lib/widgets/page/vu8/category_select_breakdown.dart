...
class _SelectCategoryPageState extends State<SelectCategoryPage> {
  static const blue = Color(0xFF1671E6);
  static const fieldGrey = Color(0xFFF2F4F5);
  ...
  bool get _canSubmit {
    return _selectedType != null && (!_needOtherText || _otherCtrl.text.trim().isNotEmpty);
  }
    ...
    try {
      ...
      if (initialName != null && initialName.isNotEmpty) {
        initial = types.firstWhere(
          ...
          orElse: () => types.isNotEmpty ? types.first :  Vu8Type(id: 0, name: ''),
        );
                          ...
                          child: Row(
                            children: [
                              ...
                              Radio<int>(
                                ...
                                onChanged: (_) => setState(() => _selectedType = type),
                                activeColor: blue,
                              ),
                            ],
                          ),
                    ...
                    onPressed: _canSubmit
                        ? () {
                            Navigator.pop<Map<String, String?>>(context, {
                              ...
                              'other': _needOtherText ? _otherCtrl.text.trim() : null,
                            });
                          }
                        : null,
