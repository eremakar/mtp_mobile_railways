...
class TrainRouteDetailPage extends StatefulWidget {
  ...
  final String noteLabel;       // Примечание (например, "Началась подготовка к рейсу")
...
class _TrainRouteDetailPageState extends State<TrainRouteDetailPage> {
  ...
  final String chiefAvatarUrl = 'assets/images/profile/1.jpg';
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              radius: 14,
                              backgroundImage: NetworkImage(chiefAvatarUrl),
                            ),
    ...
    return TableRow(
      children: [
        ...
        Padding(
          ...
          child: Text(
            step.dateTime,
            textAlign: TextAlign.right,      // <-- ключевое изменение
            style: const TextStyle(fontSize: 14),
                            ),
                          ),
                        ],
      ...
      onTap: () {
        ...
        showDialog(
          ...
          builder: (_) => AlertDialog(
            ...
            content: Text(wagon.isYourWagon ? 'Это ваш вагон!' : 'Обычный вагон.'),
            actions: [
              TextButton(
