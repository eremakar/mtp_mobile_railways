...
fun requireSunmiKeyProps(): Properties {
    val props = loadPropsOrNull(keyPropsFile)
        ?: throw GradleException(
            "android/key.properties not found. Create it to enable SUNMI signing."
        )
...
val sunmiSignTask = tasks.register<Exec>("sunmiSign") {
    ...
    doFirst {
        val props = requireSunmiKeyProps()
        val ksStoreFileRel = props.getProperty("storeFile")!!
        val ksAlias = props.getProperty("keyAlias")!!
        val ksStorePass = props.getProperty("storePassword")!!
        val ksKeyPass = props.getProperty("keyPassword")!!
